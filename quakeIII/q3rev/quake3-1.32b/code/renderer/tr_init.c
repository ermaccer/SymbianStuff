...
//		qglGetIntegerv( GL_MAX_TEXTURE_SIZE, &temp );
		glConfig.maxTextureSize = 256; //[ohi] this might save some memory...
...
void R_Register( void ) 
{
	...
	r_fsaa = ri.Cvar_Get( "r_fsaa", "0", CVAR_ARCHIVE | CVAR_LATCH );
	...
	r_subdivisions = ri.Cvar_Get ("r_subdivisions", "20", CVAR_ARCHIVE | CVAR_LATCH);
  ...
  // Default to using SMP on Mac OS X or Linux if we have multiple processors
	...
	r_primitives = ri.Cvar_Get( "r_primitives", "3", CVAR_ARCHIVE ); //[ohi]
	...
	r_shadows = ri.Cvar_Get( "cg_shadows", "0", 0 ); //[ohi]
