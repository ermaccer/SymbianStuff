...
#if (defined _M_IX86 || defined __i386__) && !defined __sun__  && !defined __LCC__ && !defined(__SYMBIAN32__)
#define id386	1
#else
#define id386	0
#endif
...
EXTERN double Q_strtod(const char* astr, char** endptr);
EXTERN double Q_atof(const char *nptr);
