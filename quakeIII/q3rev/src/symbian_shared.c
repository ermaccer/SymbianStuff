...
#if (defined __APPLE__) || defined (__SYMBIAN32__)// rcg010206 - using this for PPC builds...
...
{
#ifdef __WINSCW__
	static char cwd[] = "c:\\quake3";//[MAX_OSPATH]; // [ohi]
#else
    static char cwd[] = "e:\\quake3";//[MAX_OSPATH]; // [ohi]
#endif
